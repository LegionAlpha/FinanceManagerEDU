...
import com.legion.financemanager.databinding.FragmentIncomeBinding
...
import com.legion.financemanager.ui.view_models.IncomeFragmentViewModel
...
class IncomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnAddIncome.setOnClickListener {
            ...
            val bundle = Bundle()
            bundle.putEnum(CreateTransactionFragment.ARG_TYPE, TransactionType.Income)
